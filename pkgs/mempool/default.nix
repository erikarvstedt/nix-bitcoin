...
rec {
  ...
  src = fetchFromGitHub {
    ...
    rev = "22def9b01c8c123271cde53b0e4ce7d76a0f5416";
    hash = "sha256-ECJ5+XLdkw3tQlcbkI+Kv5qDt9Cfz2zcRwVIxUsE8zA=";
  };
  ...
  nodeModules = {
    frontend = fetchNodeModules {
      ...
      hash = "sha256-rgSZkd3JlT7SGZykWqoYIRDCp8VTirD6pLwIsUtE9rQ=";
    };
    backend = fetchNodeModules {
      inherit src nodejs;
      preBuild = "cd backend";
      hash = "sha256-s5sbQnQcIMezHkhlYXfYUt62cVKdbvvAajrB0glq7Cw=";
    };
  };

  frontendAssets = fetchFiles {
    name = "mempool-frontend-assets";
    hash = "sha256-q/8hmQGDGb/7Uks9af5OiF5iQmUl/nhpNtkZMFyd+OE=";
